...
const translations = {
  zh: {
    ...
    layerPlatformCopy: 'NetEase、QQ Music、Kugou、Bilibili 处理器负责链接识别、元数据获取、可用性检测和播放入口生成。',
    layerDataTitle: '数据层',
  ...
  en: {
    ...
    layerPlatformCopy: 'NetEase, QQ Music, Kugou, and Bilibili handlers identify links, fetch metadata, check availability, and build launch targets.',
